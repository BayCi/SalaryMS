...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *listViewCell = [tableView cellForRowAtIndexPath:indexPath];
    //下拉列表选中后，下拉框按钮的名称更改为选中的条目名称
    [_btnSender setTitle:listViewCell.textLabel.text forState:UIControlStateNormal];
    NSLog(@"下拉框改变时，内容为：%@",listViewCell.textLabel.text);
    [self myDelegate];
}

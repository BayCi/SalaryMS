...
-(void)initializeTable
{
    ...
    NSString *initializeSql=@"insert into user(username, password,e_prof,e_depart,e_place) values ('Root','123456789','管理员','管理层','新型有限公司'),('Administrator','123456789','管理员','管理层','新型有限公司'),('Manager','784951623','经理','高级管理层','新型有限公司'),('GMD','784951623','总经理','高级管理层','新型有限公司')";

...
//    [self.view addSubview:sex];
    ...
    Next.layer.cornerRadius = 8.0;
    Next.frame = CGRectMake(165, 512, 45, 45);
    ...
    [Next setTintColor:[UIColor darkGrayColor]];
    [self.view addSubview:Next];
    [Next addTarget:self action:@selector(next_click) forControlEvents:(UIControlEventTouchUpInside)];
